...
export default function ValueProposition() {
    const strengths = [
        ...
        },
        {
            ...
            description: 'Defining AI output boundaries, Human-in-the-Loop requirements, and compliance constraints as first-class product decisions — not afterthoughts.',
            icon: (
                <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        },
        {
            ...
            description: 'Scoping and shipping MVPs with explicit tradeoff decisions — deprioritising feature expansion in favour of onboarding reliability when activation data demands it.',
            icon: (
                <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
